...
public class Login extends BaseClass {
    ...
    public static String propertyFilePath="/home/arjun/Dilip/BooksWagonApplicationProject/src/test/resources/objectRepoLib.properties";
    ...
    public String login_to_application_with_invalid_from_object_repo_lib() throws InterruptedException, IOException {
        Thread.sleep(2000);
        LogClass.info("clicking on login");
        Login_Btn.click();
        Thread.sleep(2000);
        LogClass.info("Enter email id");
        sign_in_email.sendKeys(ObjectRepositoryLibrary.getLocatorProperty(propertyFilePath,"invalidUsername"));
        Thread.sleep(2000);
        LogClass.info("Enter password");
        sign_in_pwd.sendKeys(ObjectRepositoryLibrary.getLocatorProperty(propertyFilePath,"invalidPassword"));
        Thread.sleep(2000);
        LogClass.info("click on login button");
        login.click();
        Thread.sleep(3000);
